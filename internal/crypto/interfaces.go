...
type KeyPair struct {
	PrivateKey interface{} // Algorithm-specific private key (*rsa.PrivateKey, *ecdsa.PrivateKey)
	PublicKey  interface{} // Algorithm-specific public key (*rsa.PublicKey, *ecdsa.PublicKey)
